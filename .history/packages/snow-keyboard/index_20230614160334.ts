 ...
 * @LastEditTime: 2023-06-14 16:03:33
...
export class SnowKeyboard {
  ...
  private setFnKeys() {
    ...
    this.fnKeyMap.set(KeyCode.MODE, this.toggelModeEvent)
  }
  ...
  // 初始化输入法切换功能键事件
  private toggelModeEvent() {
    this.type = this.type == '中' ? 'en' : '中'
    this.shiftMode = false
    this.keyboard.toggleShiftKeys(false)
    this.keyboard.setKeyboardMode(this.getLayoutAndDictionary(this.type)[0])
  }
  // focus事件
