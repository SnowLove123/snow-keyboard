 ...
 * @LastEditTime: 2023-06-14 10:05:10
 * @FilePath: /projects/test-collect/项目收集/snow-keyboard/packages/snow-keyboard/index.ts
      ...
      if (this.type == '中') {
        ...
        if (fn) {
          ...
          isNaN(Number(keycode)) &&
            !text &&
            this.globalClickKeyEvent(e.target, Number(keycode), text)
        }
